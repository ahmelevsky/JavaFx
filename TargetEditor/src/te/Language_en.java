...
public class Language_en extends ListResourceBundle {
	...
	private Object[][] contents = {
			 { "ui.menu.data.header"   , "File"},
	            ...
	            { "alert.conf.removetheme", "Selected theme will be removed from the list. Are you sure?" },
	            { "alert.warn.existedtheme", "Can't save the theme. Such name is already present in the list" },
	            ...
	            { "alert.save.theme", "Type Theme name for displaying in the list" },
	            { "alert.select.theme", "Current table values will be cleared. Continue?" },
	            ...
	            { "ui.tabs.descriptions.minchars", "Min symbols count: "},
	            ...
	            { "ui.tabs.targets.removeconfirmation"   , "All the targets wiil be removed. Are you sure?"},
