...
import javafx.scene.control.TextField;import javafx.scene.control.Tooltip;
import javafx.scene.control.cell.TextFieldTableCell;import javafx.util.Callback;import javafx.util.StringConverter;
...
public class EditCell < S, T > extends TextFieldTableCell < S, T > {
    ...
    public void updateItem(T item, boolean empty) {
        ...
        updateItem();
        setTooltip(new Tooltip((String)item));
    }
