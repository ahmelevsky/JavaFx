...
public class MailSender {
	...
	public static void main(String[] args){
		createEmailAndSend(new ArrayList<String>(Arrays.asList( "Hello!!!")));
	}
	public static boolean createEmailAndSend(List<String> text ){
		StringBuffer body = new StringBuffer("<html>Напоминание от IDLast:<br>");
	      body.append("<br>");
	...
	//	final String username = "iz.teamcity@gmail.com";
	//	final String password = "IZpass12";
		...
		try {
			...
			message.setFrom(new InternetAddress("IDLast Reminder <idlastreminder@gmail.com>"));
			message.setRecipients(Message.RecipientType.TO,
				//InternetAddress.parse("glaesarius@mail.ru"));
					InternetAddress.parse("ahmelevsky@gmail.com"));
