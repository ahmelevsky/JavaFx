...
public class MainController implements Initializable {
	...
	public void generate(){
		...
		if (images.length==0)
			showAlert("В заданной папке нет файлов .jpg");
		else{
			try{
			for (File image:images)
				...
				showAlert("Невозможно прочитать файл, ошибка: " + e.getMessage());
			} catch (ImageWriteException e) {
				showAlert("Невозможно записать файл, ошибка: " + e.getMessage());
			} catch (IOException e) {
			...
			showAlert("Папка не выбрана или не существует");
		}
