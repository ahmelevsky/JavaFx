...
public class ShutterImageRejected {
	...
	public ShutterImageRejected(long media_id, String media_type, List<String> reasons, String uploaded_date,
	...
	public ShutterImageRejected(long media_id, String original_filename, String uploaded_date, String verdict_time) {
		this.media_id.set(media_id);
		this.uploaded_date.set(uploaded_date);
		this.original_filename.set(original_filename);
		try {
		...
		uploadedDate = LocalDate.parse(uploaded_date, formatter);
		DateTimeFormatter formatterTime = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm");
		verdictTime = LocalDateTime.parse(verdict_time, formatterTime);
		if (original_filename.endsWith("eps"))
			 setType("Vector");
	    else 
		 setType("Raster");
