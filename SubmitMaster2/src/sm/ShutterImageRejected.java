...
public class ShutterImageRejected {
	...
	private IntegerProperty upload_id = new SimpleIntegerProperty();
	...
	public ShutterImageRejected(int media_id, String media_type, List<String> reasons, String uploaded_date,
